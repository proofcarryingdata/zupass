...
import { LoginCategory, LoginConfig, LoginConfigName } from "../types";

export const ETH_LATAM_ATTENDEE_CONFIG: LoginConfig = {
  configCategoryId: LoginCategory.EthLatAm,
  ...
  name: LoginConfigName.ETH_LATAM_ATTENDEE,
...
export const DEVCONNECT_ORGANIZER_CONFIG: LoginConfig = {
  ...
  passportServerUrl: ZUPASS_SERVER_URL,
  passportAppUrl: ZUPASS_URL,
  name: LoginConfigName.DEVCONNECT_ORGANIZER,
