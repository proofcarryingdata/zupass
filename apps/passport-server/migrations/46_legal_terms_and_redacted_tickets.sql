...
CREATE TABLE devconnect_pretix_redacted_tickets (
  ...
  devconnect_pretix_items_info_id UUID NOT NULL,
  pretix_events_config_id UUID NOT NULL,
...
ALTER TABLE devconnect_pretix_tickets ADD COLUMN pretix_events_config_id UUID NOT NULL;
