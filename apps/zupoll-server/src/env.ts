...
export const ZUPASS_CLIENT_URL: string = process.env.ZUPASS_CLIENT_URL ?? "";
export const ZUPASS_SERVER_URL: string = process.env.ZUPASS_SERVER_URL ?? "";
export const ZUPOLL_CLIENT_URL: string = process.env.ZUPOLL_CLIENT_URL ?? "";
export const ZUPOLL_SERVER_URL: string = process.env.ZUPOLL_SERVER_URL ?? "";
