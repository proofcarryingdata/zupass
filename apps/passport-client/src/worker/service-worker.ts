...
const STABLE_CACHE_RESOURCES = new Set([
  ...
  "/fonts/NeueHaasUnicaPro-BoldItalic.ttf",
  "/fonts/NeueHaasUnicaPro-Heavy.ttf",
  "/fonts/NeueHaasUnicaPro-HeavyIt.ttf",
  "/fonts/NeueHaasUnicaPro-Regular.ttf",
  "/fonts/NeueHaasUnicaPro-Italic.ttf",
  "/fonts/NeueHaasUnicaPro-Light.ttf",
  "/fonts/NeueHaasUnicaPro-LightIt.ttf",
  "/fonts/NeueHaasUnicaPro-Medium.ttf",
  "/fonts/NeueHaasUnicaPro-MediumIt.ttf",
  "/fonts/NeueHaasUnicaPro-Thin.ttf",
  "/fonts/NeueHaasUnicaPro-ThinItalic.ttf",
  "/fonts/NeueHaasUnicaPro-UltLightIt.ttf",
  "/fonts/NeueHaasUnicaPro-UltraLight.ttf",
