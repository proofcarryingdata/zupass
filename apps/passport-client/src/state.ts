...
export interface AppState {
  ...
  // If Zupass is in an embedded iframe, or is embedding content in a modal to
  // be displayed above a Zapp, the state of the embedded screen.
  embeddedScreen?: ZappScreenState;
}
