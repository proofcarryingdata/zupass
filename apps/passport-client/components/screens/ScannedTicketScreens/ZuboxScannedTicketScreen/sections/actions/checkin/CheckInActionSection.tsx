...
import { ZuboxTicketActionErrorSection } from "../ZuboxTicketActionErrorSection";
import { useExecuteTicketAction } from "../useExecuteTicketAction";

/**
 * Given a Zubox ticket that Zupass has determined the curent user
