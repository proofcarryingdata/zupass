...
program
  ...
  .option(
    "-f, --force",
    "If present, forcibly overwrites the old artifacts directory rather than asking for confirmation."
  )
  .action(
    async ({
      ptauPower = 13,
      output: outputPath = "artifacts",
      force: forceOverwrite = false
    }) => {
