...
const sampleInput: ProtoPODGPCInputs = {
  ...
  objectContentID: [
    ...
    2602432266575243431375376680179885397856508428178578663580057602697100665993n
  ],
  ...
  objectSignatureR8x: [
    ...
    2230162999678969072563155271128563255583310709644866644980143538640654764283n
  ],
  objectSignatureR8y: [
    ...
    6683013612794132228389926462638766411659463494497606904372061967626436836477n
  ],
  objectSignatureS: [
    ...
    285604742822298495460652431932041504587996112757551116332689587363101445501n
  ],
  ...
  entryProofSiblings: [
    ...
    [
      5260932516895973528937464778729685272219596838129145345265769583768595720100n,
...
function makeTestSignals(
  ...
  return {
    inputs: {
      ...
      ownerSemaphoreV4SecretScalar: [
        hasOwnerV3 ? ownerIdentityV4.secretScalar : 0n
      ].slice(+!params.includeOwnerV4),
